 ...
 * @param {Boolean} options.auth.tls Use SSL/TLS to encrypt communications when auth is present. Default is true.
 * @param {Boolean} options.auth.start_tls Enable legacy SSL/TLS handshake. Default is true assuming connection to legacy pb port.
...
var schema = Joi.object().keys({
    ...
    auth: Joi.object().optional().keys({
        ...
        start_tls: Joi.boolean().default(true),
