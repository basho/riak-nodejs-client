...
StoreValue.prototype.onSuccess = function(rpbPutResp) {
    ...
    // unless returnHead or returnMeta were specified, Riak doesn't return any data 
    if (rpbPutResp) {
        var responseKey;
