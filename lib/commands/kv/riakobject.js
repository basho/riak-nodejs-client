...
var RpbLink = require('../../protobuf/riakprotobuf').getProtoFor('RpbLink');
...
RiakObject.prototype = {
     ...
     * Get the vtag.
     * @method getVTag
     * @return {Buffer} The vtag retrieved from Riak.
     */
    getVTag : function() {
        return this.vtag;
    },
...
module.exports.createFromRpbContent = function(rpbContent, convertToJs) {
    ...
    if (rpbContent.getVtag()) {
        ro.vtag = rpbContent.getVtag();
    }
