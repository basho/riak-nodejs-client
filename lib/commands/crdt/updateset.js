 ...
 * @param {String[]|Buffer[]} additions the values to be added to the set.
 * @param {String[]|Buffer[]} removals the values to remove from the set. Note that a context is required.
 ...
 * @param {Boolean} [options.returnBody] return the set.
 * @param {Number} [options.timeout] set a timeout for this command.
 * @param {Function} callback the callback to be executed when the operation completes.
 * @param {String} callback.err An error message
 * @param {Number} callback.response the set from Riak if returnBody is set or a key is generated.
 * @extends CommandBase
 */
